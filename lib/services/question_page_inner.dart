...
// ignore_for_file: unused_import, curly_braces_in_flow_control_structures, prefer_const_constructors, prefer_const_constructors_in_immutables, avoid_print
...
class _QPageInnerState extends State<QPageInner> {
  ...
  void _handleChoiceTap(int currQIdx, int index) async {
    ...
    // Update the score based on the selected answer.
    questMgr.selectAnswer(currQIdx, index);
    double newScore = questMgr.getScore();
    print('New Score: $newScore'); // Debug print statement
    widget.onScoreUpdated(newScore); // Update the score display.
  }
